...
```{r lem-size-date-fig, fig.cap = "Separation of natal-reach rearing (NRR) and downstream-rearing (DSR) types of Chinook salmon based on length and time of capture at the lower Lemhi rotary screw trap, brood years 2004-2019."}
