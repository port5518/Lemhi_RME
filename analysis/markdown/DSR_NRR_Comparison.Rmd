...
We estimated survival with a Cormack-Jolly-Seber (CJS) model [@Lebreton1992]. We consolidated all the detection sites from the lower Lemhi River RST (LLRTP) and downstream into 6 "nodes":
